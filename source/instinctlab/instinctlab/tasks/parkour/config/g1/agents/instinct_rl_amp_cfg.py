...
@configclass
class MoEPolicyCfg_2Experts(MoEPolicyCfg):
    """Same as :class:`MoEPolicyCfg` but with fewer experts, for the simpler stairs+flat terrain."""
...
@configclass
class G1ParkourStairsFlatPPORunnerCfg(G1ParkourPPORunnerCfg):
    """Same as :class:`G1ParkourPPORunnerCfg` but uses fewer MoE experts since the stairs+flat
